...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->çàâîäÏîëèıôToolStripMenuItem->Size = System::Drawing::Size(196, 22);
			this->çàâîäÏîëèıôToolStripMenuItem->Text = L"Çàâîä \"Ïîëèıô\"";
			this->çàâîäÏîëèıôToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::çàâîäÏîëèıôToolStripMenuItem_Click);
			// 
			// çàâîäÓôàîğãñèíòåçToolStripMenuItem
			// 
			this->çàâîäÓôàîğãñèíòåçToolStripMenuItem->Name = L"çàâîäÓôàîğãñèíòåçToolStripMenuItem";
			this->çàâîäÓôàîğãñèíòåçToolStripMenuItem->Size = System::Drawing::Size(196, 22);
			this->çàâîäÓôàîğãñèíòåçToolStripMenuItem->Text = L"Çàâîä \"Óôàîğãñèíòåç\"";
			...
			this->çàâîäÏîëèıôToolStripMenuItem1->Size = System::Drawing::Size(196, 22);
			this->çàâîäÏîëèıôToolStripMenuItem1->Text = L"Çàâîä \"Ïîëèıô\"";
			...
			this->çàâîäÓôàîğãñèíòåçToolStripMenuItem1->Size = System::Drawing::Size(196, 22);
			this->çàâîäÓôàîğãñèíòåçToolStripMenuItem1->Text = L"Çàâîä \"Óôàîğãñèíòåç\"";
			...
			this->tabPage_uos->Text = L"Ñïèñîê òîâàğîâ \"Óôàîğãñèíòåç\"";
			...
			this->tabPage_p->Text = L"Ñïèñîê òîâàğîâ \"Ïîëèıô\"";
	...
	private: System::Void çàâîäÏîëèıôToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e);
